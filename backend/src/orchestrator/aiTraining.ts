...
3. Scene rendering: Tier 0 HuggingFace Spaces (free GPUs, round-robin) → OSS APIs (DeepInfra, Replicate OSS) → premium last (Fal/Kling/Luma/Runway) → FFmpeg slideshow (never fails). Route 80% establishing/dialogue/B-roll to HF Spaces; money shots try free first, premium only when all free endpoints fail.
