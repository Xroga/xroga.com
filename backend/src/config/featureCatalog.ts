...
export const FEATURE_CATALOG: FeatureCatalogEntry[] = [
  ...
  { id: 'image_generation', name: 'Image Generation', category: 'Media', agent: 'builder', systemPrompt: 'Cost-optimized image pipeline: Groq classify → DeepSeek enhance → Fal/Replicate/Agnes/Luma/Runway with silent fallback.', promptTemplate: 'Generate an image of: ', estimatedSeconds: 45, actionCost: 4, keywords: ['image', 'picture', 'logo', 'art'] },
  ...
  { id: 'typewriter', name: 'Modern response streaming', category: 'UI', agent: 'architect', systemPrompt: 'Modern fade-in streaming for AI responses.', promptTemplate: '', estimatedSeconds: 0, actionCost: 0, keywords: ['typewriter', 'streaming', 'animation'] },
