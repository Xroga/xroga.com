...
export const FEATURE_CATALOG: FeatureCatalogEntry[] = [
  ...
  { id: 'image_generation', name: 'Image Generation', category: 'Media', agent: 'builder', systemPrompt: 'Generate image via Agnes AI (primary), Fal/Replicate/Cloudflare fallback.', promptTemplate: 'Generate an image of: ', estimatedSeconds: 45, actionCost: 4, keywords: ['image', 'picture', 'logo', 'art'] },
