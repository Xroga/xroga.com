...
export const TASK_CATALOG: TaskDefinition[] = [
  ...
  },
  {
    ...
    description: 'Refer a friend to Xroga AI — both earn 250K AI tokens + 5,000 XRG instantly on subscription',
    platform: 'Any',
    frequency: 'Unlimited referrals',
    xrgReward: 5000,
    tokenBoost: 250000,
    verification: 'automatic',
    requirements: [
      ...
      'Both receive 250,000 AI tokens + 5,000 XRG instantly',
      'After 3 months: both receive 190,000 AI tokens + 5,000 XRG bonus',
      'You earn +1% subscription discount per referral (max 15%)',
    ],
    examplePost: 'Share your referral link — rewards credit automatically when your friend subscribes.',
  },
  {
    id: 'ugc_challenge',
    cadence: 'special',
