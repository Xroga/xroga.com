/** Islamic safety guidance shown when explicit content is blocked */
...
export type ImageBlockReason = 'prompt_blocked' | 'image_blocked' | 'verification_failed';

export function buildImageBlockedOutput(
  prompt: string,
  ...
  return {
    ...
    reason,
    detail,
    safety: IMAGE_SAFETY_GUIDANCE,
    followUps: IMAGE_SAFETY_GUIDANCE.creativeAlternatives,
  };
}
