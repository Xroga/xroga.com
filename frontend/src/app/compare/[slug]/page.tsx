...
const LOVABLE_SLUG = 'xroga-vs-lovable';
...
export async function generateMetadata({
  ...
  if (slug === LOVABLE_SLUG) {
    const base = buildMetadata({
      title: XROGA_VS_LOVABLE_TITLE,
    ...
    const image = `${SITE_URL}${XROGA_VS_LOVABLE_OG_IMAGE}`;
    ...
    return {
      ...
      openGraph: {
        type: 'article',
        locale: 'en_US',
        url: `${SITE_URL}${XROGA_VS_LOVABLE_PATH}`,
        siteName: SITE_NAME,
        title: XROGA_VS_LOVABLE_TITLE,
        description: XROGA_VS_LOVABLE_DESCRIPTION,
        ...
        images: [
          {
            ...
            width: 1200,
            height: 630,
            alt: 'Xroga vs Lovable 2026 AI app builder comparison',
          },
        ],
      },
...
export default async function Comparison({
  ...
  /*
   * Xroga vs Lovable has its own researched long-form comparison.
   * Other comparisons continue using the generic template until
   * they are manually upgraded.
   */
  if (slug === LOVABLE_SLUG) {
    return <XrogaVsLovablePage />;
  }
  ...
  return (
    <EditorialPage
      ...
      breadcrumbs={[
        ...
        {
          label: `Xroga vs ${page.competitor}`,
          href: `/compare/${slug}`,
        },
      ]}
      sources={page.sources}
      related={['/compare', '/ai-app-builder', '/pricing']}
      sections={[
        {
          heading: `When ${page.competitor} may be the better fit`,
          paragraphs: [page.bestFor],
        },
        {
          heading: 'What the official documentation confirms',
          paragraphs: [
        ...
        {
          heading: 'How Xroga approaches the work',
          paragraphs: [page.xrogaDifference],
        },
        {
          heading: 'Questions to decide with',
          paragraphs: [
            'Use a representative project and answer these before choosing a platform.',
          ],
          bullets: page.decisionPoints,
        },
        {
