  ...
  useEffect(() => {
    ...
    function draw(timestamp: number) {
      ...
      particles.forEach((particle, index) => {
        const px =
          particle.x * width +
          Math.sin(time * particle.drift * 5 + particle.phase) * 24;

        const wrappedY =
          (particle.y * height + time * (8 + index * 0.07)) %
            (height + 120) -
          60;

        const alpha =
          0.12 + Math.sin(time * 0.7 + particle.phase) * 0.06;

        context.beginPath();
        context.arc(px, wrappedY, particle.r, 0, Math.PI * 2);

        context.fillStyle = `rgba(151, 132, 255, ${Math.max(
          alpha,
          0.03,
        )})`;
      ...
      for (let index = 0; index < lineCount; index += 1) {
        ...
        const pulse =
          0.018 + (Math.sin(time * 0.2 + index) + 1) * 0.006;
    ...
    <main className={styles.pageShell}>
      ...
      <header className={styles.siteHeader}>
        ...
        <nav
          ...
          aria-label="Cybersecurity navigation"
        >
        ...
        <div className={styles.heroFrame}>
          ...
          <div className={styles.heroContent}>
            ...
            >
              ...
              >
                Xroga is developing a new
                AI-native cybersecurity initiative
                for 2027 — built around better
                context, faster reasoning, and
            ...
            >
              ...
              >
                <label
                  ...
                  htmlFor="cyber-question"
                >
                  Ask a conceptual cybersecurity
                  question
                </label>
                ...
                <button
                  type="submit"
                  aria-label="Preview concept interaction"
                >
                  <ArrowRightIcon />
                </button>
              </form>
              ...
              <div
                className={styles.consoleChips}
              >
                <button
                  type="button"
                  onClick={() =>
                    setDemoValue(
                      "Analyze current risk posture",
                    )
                  }
                >
                  <ShieldIcon size={13} />
                ...
                <button
                  ...
                  onClick={() =>
                    setDemoValue(
                      "Map controls to a security framework",
                    )
                  }
                >
                  <LayersIcon size={13} />
                ...
                <button
                  ...
                  onClick={() =>
                    setDemoValue(
                      "Prepare an incident investigation path",
                    )
                  }
                >
                  <PulseIcon size={13} />
          ...
          >
            ...
            <p>
              Built for a security world where
              speed and context matter more than
              dashboards.
            </p>
          </div>
          ...
          >
            ...
            <p>
              Public direction today. Product
      ...
      >
        ...
        >
          ...
          <h2>
            ...
            <br />
            Security intelligence has to evolve
            with it.
          </h2>
        </div>
        ...
        <div className={styles.visionGrid}>
          ...
          >
            <p>
              ...
              tools and telemetry. The harder
              problem is turning all of that into
              reliable context quickly enough to
              make the right decision.
            </p>

            <p>
              Xroga Cybersecurity is being explored
              around that problem: using AI to
              connect signals, reason over risk,
              prepare investigations and make
              complex security information easier
              to act on — without removing human
              control.
            </p>
          </div>
          ...
          <div className={styles.principles}>
            ...
            <article data-reveal>
              ...
              <p>
                ...
                Critical security decisions stay
                accountable.
              </p>
            </article>
            ...
            <article data-reveal>
              ...
              <p>
                ...
                expose confidence, evidence and
                unknowns.
              </p>
            </article>
          </div>
      ...
      >
        ...
        >
          <div>
            ...
            <h2>
              What Xroga is exploring.
            </h2>
          </div>

          <p className={styles.sectionNote}>
            These are R&amp;D directions, not
            claims of currently released product
            functionality.
          </p>
        </div>
      ...
      >
        ...
        >
          <div>
            ...
            <h2>
              From raw signal to useful action.
            </h2>
          </div>

          <p className={styles.sectionNote}>
            A conceptual operating model for how
            an AI-native security layer could
        ...
        >
          <div
            className={
              styles.systemPanelHeader
            }
          >
            <span>
              XROGA SECURITY INTELLIGENCE /
              CONCEPT
            </span>

            <span>
              ARCHITECTURE STUDY 2026 → 2027
            </span>
          </div>
          ...
          >
            <div
              className={styles.diagramSources}
            >
              <span>ASSETS</span>
            ...
            <div
              className={styles.diagramOutputs}
            >
      ...
      >
        ...
        >
          ...
          >
            ...
            <h2>
              We are building toward 2027.
            </h2>

            <p>
              This page is a statement of
              direction. Xroga is actively
              exploring the cybersecurity space
              and the role AI can play in making
              security operations more
              understandable, connected and
              responsive.
            </p>

            <p>
              The final product shape may evolve
          ...
          >
            <div>
              ...
              <p>
                ...
                exploration and security-domain
                design.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Testing workflows, intelligence
                models and real-world operator
                needs.
              </p>
            </div>
      ...
      <section className={styles.finalCta}>
        ...
        >
          ...
          >
            <p>
              It will be intelligence that can
              understand context, reason with
              evidence and help humans move
              faster.
            </p>
      ...
      <footer className={styles.footer}>
        ...
        <p>
          AI-native cybersecurity direction ·
          Target 2027
        </p>

        <p>
          © {new Date().getFullYear()} Xroga.
          All rights reserved.
        </p>
      </footer>
    </main>
...
function ShieldIcon({
  ...
  return (
    ...
    >
      <path
        d="M12 3L19 6V11C19 15.6 16.4 19 12 21C7.6 19 5 15.6 5 11V6L12 3Z"
        stroke="currentColor"
        strokeWidth="1.6"
      />
...
function NetworkIcon({
  ...
  return (
    ...
    >
      ...
      <path
        d="M8 7L16 6.2M7.4 9L6.6 15M9 16.8L15 18M17.8 8L17.2 16"
        stroke="currentColor"
        strokeWidth="1.4"
      />

      <path
        d="M8.2 8.3L15.5 16.2"
        stroke="currentColor"
        strokeWidth="1.1"
        opacity="0.6"
      />
...
function PulseIcon({
  ...
  return (
    ...
    >
      <path
        d="M3 12H7L9.3 7L13 17L15.5 11H21"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
        strokeLinejoin="round"
...
function SparkIcon({
  ...
  return (
    ...
    >
      ...
      <path
        d="M18.5 15L19.2 17.1L21.3 17.8L19.2 18.5L18.5 20.6L17.8 18.5L15.7 17.8L17.8 17.1L18.5 15Z"
        fill="currentColor"
      />
    </svg>
  );
