          ...
          <div className="flex items-center gap-2 px-3 py-2 flex-wrap border-none">
            ...
            {QUICK_CHIPS.slice(1).map((name) => (
              <button
                ...
                type="button"
                onClick={() => setIntegrationsOpen(true)}
                className="hidden sm:inline px-2 py-1 rounded-lg text-[10px] hover:bg-white/10 transition-colors"
              >
                {name}
              </button>
            ))}
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-[10px] sm:text-xs font-terminal hover:opacity-80 transition-opacity whitespace-nowrap"
            >
