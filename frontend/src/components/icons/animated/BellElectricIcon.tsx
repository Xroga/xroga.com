...
interface BellElectricIconProps
  extends Omit<
...
/**
 * A bell that rings, with the sound coming off it.
 *
 * The whole glyph rocks on a damped swing — the amplitudes fall away rather than
 * repeating evenly, which is what a struck bell does. The two arcs pulse behind it and
 * the striker presses in, so the ring reads even where the motion is small.
 */
