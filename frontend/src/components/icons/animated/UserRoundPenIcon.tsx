...
/**
 * A person with a pen — the mark for the account details you can edit.
 *
 * Three motions in sequence: the head pops in, the shoulders draw themselves along
 * their own stroke, and the pen swings across as if signing. The stroke draw is what
 * makes it read as "fill this in" rather than as a portrait that happens to wobble.
 */
  ...
  (
    ...
    const bodyVariants: Variants = {
      ...
      animate: {
        ...
        opacity: [0.3, 1],
        transition: { duration: 0.7 * duration, delay: 0.2, ease: 'easeInOut' },
      },
    };
      ...
      >
        ...
        >
          <m.path
            ...
            animate={controls}
          />
          <m.circle cx="10" cy="8" r="5" variants={headVariants} initial="normal" animate={controls} />
          <m.path
