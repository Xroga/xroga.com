...
/**
 * A person with a star — the founder, not another account row.
 *
 * The star is the only part that turns, and it overshoots twice before settling, so
 * it reads as being awarded rather than as sitting there. The figure draws itself in
 * behind it.
 */
      ...
      >
        ...
        >
          <m.path
            ...
            animate={controls}
          />
          <m.circle cx="10" cy="7" r="4" variants={headVariants} initial="normal" animate={controls} />
          <m.path
