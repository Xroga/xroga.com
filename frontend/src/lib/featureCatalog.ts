...
export const FEATURE_CATALOG_FRONTEND: FeatureCatalogItem[] = [
  ...
  { id: 'ai_video', name: 'AI Video Generation', category: 'Media', promptTemplate: 'Generate a video about: ' },
  { id: 'movie_script', name: 'Movie & drama scripts', category: 'Creative', promptTemplate: 'Write a movie script about: ' },
