...
function slimLandingOutput(output: unknown): unknown {
  ...
  return {
    ...
    netlifyPreviewUrl: o.netlifyPreviewUrl,
    githubRepoUrl: o.githubRepoUrl,
    githubRepoName: o.githubRepoName,
    githubPushConfirmed: o.githubPushConfirmed,
    githubBranch: o.githubBranch,
    commitSha: o.commitSha,
    buildOk: o.buildOk,
    shipped: o.shipped,
    fullyShipped: o.fullyShipped,
    handoffReady: o.handoffReady,
    shipBlockers: o.shipBlockers,
    shipOutcome: o.shipOutcome,
    changesSummary: o.changesSummary,
    completedTodos: o.completedTodos,
    qa: o.qa,
    shipVerify: o.shipVerify,
    nextSteps: o.nextSteps,
    envSync: o.envSync,
    scaffoldKind: o.scaffoldKind,
    isUpdate: o.isUpdate,
