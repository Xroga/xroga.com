...
export const DOC_PAGES: DocPage[] = [
  ...
  { slug: 'hackathon-workflows', title: 'Hackathon workflows', description: 'Turn official rules into an achievable, tested, demonstrable submission.', updated: '2026-07-30', sourceHref: '/crypto', sections: [
