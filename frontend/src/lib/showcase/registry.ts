...
export const SHOWCASE_TEMPLATES: readonly ShowcaseTemplate[] = [
  ...
  },
  {
    id: 'android-app',
    slug: 'android-app',
    name: 'Athlyra Fitness Tracker',
    category: 'Mobile app',
    shortDescription: 'An Android-first fitness tracker with workouts, progress, hydration, and Xroga Coach.',
    longDescription:
      'Athlyra is an Android-first Expo and React Native fitness product concept. Its interactive preview includes readiness and daily metrics, hydration tracking, a live workout timer and set logger, progress charts, a clearly labelled local fitness coach, goals, and connected-health states. Demo activity persists locally in the browser; no APK or store release is claimed.',
    capabilities: [
      'Today dashboard with readiness, steps, active minutes, calories, and hydration',
      'Live workout timer, set logging, exercise queue, and completion flow',
      'Progress ranges, weight trend, consistency, volume, and weekly activity load',
      'Clearly labelled local Xroga Coach demonstration',
      'Goals, demo profile, pedometer, and cloud-sync integration states',
      'Offline-first browser persistence for interactive demo activity',
    ],
    ...
    mobileApp: true,
    accent: '#d9ff66',
    demoDataNotice: 'Fitness metrics, profile information, and coach replies are demonstration data. No APK, sensor feed, cloud account, or store release is claimed.',
    defaultBuildPrompt:
      'Customize the Athlyra Android fitness tracker. Preserve the five core tabs, workout tracking, progress views, local persistence, honest integration states, and Android-safe spacing.',
    guidedQuestions: [
      {
        id: 'purpose',
  ...
  },
  {
    ...
    category: 'Game',
    shortDescription: 'Riftbreaker: a five-mission neon action game with combat, phase shifting, and touch controls.',
    longDescription:
      'Riftbreaker: Neon Vault is a genuinely playable Canvas campaign. Recover Rift Cores, fight sentinels, cross laser grids, shift between cyan and magenta realities, and defeat the Guardian across five missions. Progress and best score are saved on the device, with keyboard and on-screen touch controls.',
    capabilities: [
      'Five-level campaign and mission selection',
      'Real-time movement, projectiles, enemies, and collision',
      'Rift Core recovery and phase-shifting mechanics',
      'Pause, retry, mission progression, and boss encounter',
      'Keyboard and responsive on-screen controls',
      'Campaign progress and best score saved locally',
    ],
    ...
    accent: '#19e4ff',
    defaultBuildPrompt:
      'Customize the Riftbreaker playable game. Preserve its five missions, combat, phase shifting, campaign progress, and keyboard and touch controls.',
    guidedQuestions: [
      {
        id: 'theme',
