...
export const FEATURE_SEO_PAGES: FeatureSeoPage[] = [
  ...
  },
  {
    ...
    headline: 'AI Video Prompts — Coming Soon on Xroga',
    description:
      'Xroga AI video generation is coming soon. Today, get polished prompts for Runway, Pika, Kling, and other video tools — plus live image generation and full-stack builds.',
    keywords: [
      'AI video prompts',
    ...
    bullets: [
      'Detailed prompts for external video AI tools',
      'Live image generation on Xroga today',
      'Websites, apps, games, and automations in one chat',
      'Honest token pricing on every action',
    ],
    faq: [
      { q: 'Can Xroga generate videos?', a: 'Not yet — Xroga AI video generation is coming soon. Ask for a video prompt to use in Runway, Pika, or Kling, or generate images directly in Xroga.' },
    ],
