...
The current gate additionally verifies the production billing configuration through an authenticated checkout request and accepts only a dynamically generated HTTPS Whop URL. It never submits the hosted checkout or charges a card.
