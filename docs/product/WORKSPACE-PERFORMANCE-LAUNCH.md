...
| Prompt to visible acknowledgement | Not recoverable from existing rendered history | Pending production retest | Do not fabricate |
...
| Direct chat completion | Not yet measured in this pass | Pending | Do not fabricate |
| Search completion | Not yet measured in this pass | Pending | Do not fabricate |
